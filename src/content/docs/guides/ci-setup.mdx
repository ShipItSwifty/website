...
| Job | Runner | Scope |
| --- | ------ | ----- |
| `build-and-test` | `macos-latest` | Main build, unit tests, CLI tests |
| `cross-platform-fixture-integration` | `macos-latest` | Blocking Flutter + React Native + KMP fixture integration suites |
