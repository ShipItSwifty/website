      ...
      <div>
        ...
        <div className="mb-10">
          ...
          <p className="mb-4 text-sm leading-[1.7]" style={{ color: "var(--fg2)" }}>
            Run <code className="rounded px-1.5 py-px text-xs" style={{ fontFamily: "var(--font-mono)", color: "var(--brand)", background: "var(--brand-muted)" }}>shipit generate</code>{" "}
            to inspect your project and scaffold a <code className="rounded px-1.5 py-px text-xs" style={{ fontFamily: "var(--font-mono)", color: "var(--fg2)", background: "var(--elevated)" }}>Shipfile.yml</code>{" "}
            in seconds. It walks through the missing answers, detects your scheme and bundle ID,
            and writes a reviewable config you can commit.
          </p>
      ...
      <div className="flex flex-col gap-6">
        <div className="rounded-[10px] border p-6" style={{ background: "var(--surface)", borderColor: "var(--border)" }}>
          ...
          <p className="mt-4 text-[13px] leading-[1.65]" style={{ color: "var(--fg2)" }}>
            ...
            commit it. Every CI run after that is just <code style={{ fontFamily: "var(--font-mono)", color: "var(--brand)", fontSize: 12 }}>shipit run</code>.
          </p>
        </div>
        ...
        <div className="rounded-[10px] border p-6" style={{ background: "var(--surface)", borderColor: "var(--border)" }}>
          ...
          {["macOS 15+, Xcode 16+", "Swift 6 toolchain", "Apple Developer account", "App Store Connect API key"].map((item) => (
            <div key={item} className="mb-2.5 flex items-center gap-2.5 text-[13px]" style={{ color: "var(--fg2)" }}>
          ...
          {showDocsLink ? (
            <div className="mt-4 border-t pt-4" style={{ borderColor: "var(--border)" }}>
              <Link href="/docs/getting-started/walkthrough" className="inline-flex items-center gap-1 text-[13px]" style={{ color: "var(--blue)" }}>
        ...
        <div className="rounded-[10px] border p-6" style={{ background: "var(--surface)", borderColor: "var(--border)" }}>
          ...
          <p className="mb-3.5 text-[13px] leading-[1.65]" style={{ color: "var(--fg2)" }}>
            ...
            variables and set <code className="rounded px-1.5 py-px text-xs" style={{ fontFamily: "var(--font-mono)", color: "var(--brand)", background: "var(--brand-muted)" }}>--ci</code>{" "}
