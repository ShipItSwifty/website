  ...
  return (
    ...
    >
      <path
        ...
        fill="#F05138"
      />
      <path d="M30 4C34 0 38 1 38 5C38 11 32 17 28 24C28 24 30 14 30 4Z" fill="#FF7A65" />
      <path d="M14 40C11 45 16 50 18 45C19 42 15 40 14 40Z" fill="#F05138" opacity="0.55" />
